	...
	'use strict';
     ...
     function init_de() {
		...
		jQuery("#selector .opt").on("click", function() {
            ...
            jQuery("#colors").attr("href", 'colors/'+color+'.css');
            jQuery(this).addClass("active");
         });
     ...
     // rtl begin //
      if (rtl_mode=="on") {
            ...
            jQuery("#bootstrap").attr("href", 'bootstrap.rtl.min.css');
            jQuery("#bootstrap-grid").attr("href", 'bootstrap-grid.rtl.min.css');
            jQuery("#bootstrap-reboot").attr("href", 'bootstrap-reboot.rtl.min.css');
            jQuery("#mdb").attr("href", 'mdb.rtl.min.css');
            ...
            var iteration = $(this).data('iteration') || 1;
             switch (iteration) {
                 ...
                 case 2:
                    ...
                    jQuery("#bootstrap").attr("href", 'bootstrap.min.css');
                    jQuery("#bootstrap-grid").attr("href", 'bootstrap-grid.min.css');
                    jQuery("#bootstrap-reboot").attr("href", 'bootstrap-reboot.min.css');
                    jQuery("#mdb").attr("href", 'mdb.min.css');
